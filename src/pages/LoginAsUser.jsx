                ...
                <div className="content2 ">
                    <div className="login" >
                        <div className="frist">
                            ...
                            <input type="text" name="username" id="logName" placeholder="username" onChange={(e) => changeData(e)} />
                            <p className="text-danger" style={{ fontSize: "15px" }}>{usernameErr}</p>
                        </div>
                        <div className="frist">
                            <label for="logPassword">Password</label>
                            <input type="password" name="password" id="logPassword" placeholder="password" onChange={(e) => changeData(e)} />

  ...
  function changeData(e) {
    if (e.target.name === "username") {
      ...
      if (e.target.value.length < 3 || e.target.value.length > 80) {
        seterrdata({
          ...errdata,
          facebook_linkErr: "This Field Has To Be 3 to 80 Characters Long",
        });
        seterrdataB({
          ...errdataB,
          facebook_linkErrB: false,
    ...
    <>
      <div className="containeruser">
        ...
        <form className="myform">
          <div className="user-details">
            ...
            <div className="iteeeemss">
              ...
              <input
                ...
                className="iteeemvalue"
                name="phone"
                placeholder="Enter Your egyption PhoneNumber"
                id="phone"
                onChange={(e) => changeData(e)}
              />
              <p className="text-danger" style={{ fontSize: "13px" }}>
            ...
            <div className="extraaa">
              <label htmlFor="bdate" className="extrafeiiild">
                Birth Date
              </label>
              <input
                type="date"
                className="feiiildvalue"
                id="bdate"
          ...
          <div className="extraaa">
            <label htmlFor="Address" className="extrafeiiild">
              Address
            </label>
            <input
              type="text"
          ...
          <div className="extraaa">
            <label htmlFor="faceLink" className="extrafeiiild">
              Facebook Page
            </label>
            <input
              type="text"

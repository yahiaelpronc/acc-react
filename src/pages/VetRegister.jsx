    ...
    <>
      <div className="containervet">
        ...
        <form className="myform">
          ...
          <div className="extra">
            <label htmlFor="bdate" className="extrafeild">
              Birth Date
            </label>
            <input
              type="date"
          ...
          <div className="extra">
            <label htmlFor="Address" className="extrafeild">
              Address
            </label>
            <input
              type="text"
          ...
          <div className="extra">
            <label htmlFor="faceLink" className="extrafeild">
              Facebook Page
            </label>
            <input
              type="text"
